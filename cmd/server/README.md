...
# run with crypto key
go run cmd/server/main.go -a="127.0.0.1:1212" -f="temp-bla" -i="5s" -d="postgres://postgres:mysecretpassword@localhost:13131/postgres?sslmode=disable" -r=true -k=bhygyg --generate-crypto-keys --crypto-key="key.pem"
# windows
